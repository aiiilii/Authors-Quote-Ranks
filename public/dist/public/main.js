...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/index']\">Back</button><br>\n<!-- <p>Author Name: {{ oneAuthor.name }}</p> -->\n\n<div *ngIf=\"errors.name\">{{ errors.errors.name.message }}</div>\n\nName: <input type=\"text\" name=\"name\" value={{oneAuthor.name}} required minlength=\"3\" [(ngModel)]=\"oneAuthor.name\" #name=\"ngModel\" />\n<button [routerLink]=\"['/index']\">Cancel</button>\n<button (click)=\"editAuthor(oneAuthor._id)\">Save!</button>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/create']\">Add an author!</button>\n<p>All Authors!</p>\n\n<table>\n    <thead>\n        <th>Author</th>\n        <th>Actions</th>\n    </thead>\n    <tr *ngFor=\"let author of authors\">\n        <td>{{ author.name }}</td>\n        <td><button routerLink=\"/show/{{ author._id }}\">Show</button>\n            <button routerLink=\"/quotes/{{ author._id }}\">Show Quotes</button>\n            <button routerLink=\"/edit/{{ author._id }}\">Edit</button>\n            <button (click)=\"deleteAuthor(author._id)\">Delete</button>\n        </td>\n    </tr>\n</table>\n\n\n<!-- <div *ngFor=\"let author of authors\">\n    <p>Author name: {{ author.name }}</p>\n    <button routerLink=\"/show/{{ author._id }}\">Show!</button>\n</div> -->\n<!-- <button [routerLink]=\"['/quotes', author._id]\">View Quotes</button> -->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/index']\">Home</button>\n<p>Create a new Author!</p>\n\n<div *ngIf=\"errors.name\">{{ errors.errors.name.message }}</div>\n\nName: <input type=\"text\" name=\"name\" required minlength=\"3\" [(ngModel)]=\"newAuthor.name\" #name=\"ngModel\" />\n<button (click)=\"createAuthor()\">Add!</button>\n\n<!-- <form (submit)=\"createAuthor()\">\n    Name: <input type=\"text\" name=\"name\" required minlength=\"3\" [(ngModel)]=\"newAuthor.name\" #name=\"ngModel\" />\n    <input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Add!\" />\n</form> -->\n<!-- <div *ngIf=\"!name.valid\">* Name needs to be at least 3 characters</div> -->\n<p *ngIf=\"addedAuthor\">{{addedAuthor.name}} was added to the database!</p>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/index']\">Home</button>\n<button routerLink=\"/write/{{ oneAuthor._id }}\">Add a quote!</button>\n\n<p>Quotes by {{ oneAuthor.name }}</p>\n\n<table>\n  <thead>\n    <th>Quote</th>\n    <th>Votes</th>\n    <th>Actions</th>\n  </thead>\n  <tr *ngFor=\"let quote of oneAuthor.quotes\">\n    <td>{{ quote.content }}</td>\n    <td>{{ quote.score }}</td>\n    <td>\n      <button (click)=\"vote(1, quote._id)\">Vote Up</button>\n      <button (click)=\"vote(-1, quote._id)\">Vote Down</button>\n      <button (click)=\"delete(quote._id)\">Delete</button>\n    </td>\n  </tr>\n</table>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/index']\">Back</button>\n<p>Author Name: {{ oneAuthor.name }}</p>\n<!-- <p>Created at: {{ oneAuthor.createdAt }}</p>\n<p>Updated at: {{ oneAuthor.updatedAt }}</p> -->\n<button (click)=\"deleteAuthor(oneAuthor._id)\">Delete!</button>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button [routerLink]=\"['/home']\">Home</button>\n\n<p>Provide a quote by {{ oneAuthor.name }}:</p>\n\n<div *ngIf=\"errors.name\">{{ errors.errors.quotes.errors.content.message }}</div>\n<form #writeForm=\"ngForm\" (submit)=\"submit()\">\n    <input\n        class=\"form-control\"\n        type=\"text\"\n        required\n        minlength=\"3\"\n        [(ngModel)]=\"content\"\n        #name=\"ngModel\"\n        name=\"content\"\n    >\n    <!-- <button [routerLink]=\"['/quotes', authorid]\">Cancel</button> -->\n    <button routerLink=\"/quotes/{{ oneAuthor._id }}\">Cancel</button>\n    <!-- <button [disabled]=\"writeForm.invalid\" (click)=\"submit()\" routerLink=\"/quotes/{{ oneAuthor._id }}\">Submit</button> -->\n    <input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Submit\">\n</form>\n");
...
const routes = [
    ...
    { path: 'create', component: _new_new_component__WEBPACK_IMPORTED_MODULE_4__["NewComponent"] },
    ...
    { path: 'quotes/:authorid', component: _quote_quote_component__WEBPACK_IMPORTED_MODULE_7__["QuoteComponent"] },
    { path: 'write/:authorid', component: _write_write_component__WEBPACK_IMPORTED_MODULE_8__["WriteComponent"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3dyaXRlL3dyaXRlLmNvbXBvbmVudC5jc3MifQ== */");
...
WriteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./write.component.css */ "./src/app/write/write.component.css")).default]
    })
], WriteComponent);
...
module.exports = __webpack_require__(/*! /Users/aili/code/CodingDojo/mean_stack/angular_mean/Angular/Authors/public/src/main.ts */"./src/main.ts");
